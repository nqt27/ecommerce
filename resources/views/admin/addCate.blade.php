...
<body class="hold-transition sidebar-mini layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form method="post" action="{{ route('categories.store') }}" class = "form-wrapper">
            @csrf <!-- Thêm CSRF token vào form -->
                ...
                <div class="mb-3 row">
                    ...
                    <input class="form-control" value = 1 name="role"/>
                </div>
...
<!-- 
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="{{route('admin.cate')}}" class="btn btn-secondary form-control">Back to list</a>
                    </div>
                </div>
            </form>
        </div>
